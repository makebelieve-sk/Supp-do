...
router.get(
    "/equipment-property/:id",
    (req, res, next) => {
        AuthMiddleware.canRead(req, res, next, "equipmentProperties").then(null);
    },
    async (req, res) => {
...
router.post(
    ...
    checkMiddleware,
    (req, res, next) => {
        AuthMiddleware.canEdit(req, res, next, "equipmentProperties").then(null);
    },
    async (req, res) => {
        try {
